...
use App\Jobs\Webhook\ProcessOnboardingWebhooks;
...
return [
    'configs' => [
        [
             ...
             */
            'signature_header_name' => 'X-Grok-Signature',
             ...
             */
            'process_webhook_job' => ProcessOnboardingWebhooks::class,
        ],
    ],
